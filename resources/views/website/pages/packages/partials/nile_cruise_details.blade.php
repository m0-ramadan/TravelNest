@if ($package->package_type === 'nile_cruise')
    ...
    @if ($hasNcExtendedData)
        <style>
            ...
            .nc-duration-tab {
                border: 1.5px solid var(--rich-gold, #c5955b);
                background: #ffffff;
                color: var(--primary-navy, #1c325c);
                padding: 10px 18px;
                border-radius: 999px;
            ...
            .nc-duration-tab.active,
            .nc-duration-tab:hover {
            ...
            .nc-activity {
                padding: 12px 0;
                border-top: 1px solid rgba(28, 50, 92, 0.08)
            }
            ...
            html[data-theme='dark'] .nc-day summary {
                color: #ffffff !important;
            }

            html[data-theme='dark'] .nc-pill {
                background: rgba(197, 149, 91, 0.18) !important;
                color: #f4c36a !important;
                border-color: rgba(197, 149, 91, 0.3) !important;
            }

            html[data-theme='dark'] .nc-duration-tab {
                background: #151d30 !important;
                color: #e2e8f0 !important;
                border-color: rgba(197, 149, 91, 0.4) !important;
            }

            html[data-theme='dark'] .nc-duration-tab.active {
                background: var(--gradient-gold, #c5955b) !important;
