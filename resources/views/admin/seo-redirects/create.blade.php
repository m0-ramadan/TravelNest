                ...
                <form action="{{ route('admin.seo-redirects.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="old_path" class="form-control" value="{{ old('old_path') }}"
                                placeholder="/old-page">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">New Path</label>
                            <input type="text" name="new_path" class="form-control" value="{{ old('new_path') }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="http_code" class="form-select">
                                <option value="301" {{ old('http_code') == '301' ? 'selected' : '' }}>301</option>
                                <option value="302" {{ old('http_code') == '302' ? 'selected' : '' }}>302</option>
                            </select>
                        </div>
