        ...
        <div class="order-card">
            <div class="order-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-0">تعديل مقال جديد</h5>
                        <small class="opacity-75">إدخال بيانات المقال الأساسية</small>
                    </div>
                ...
                <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="seo_description" class="form-control" rows="3">{{ old('seo_description', $article->seo_description) }}</textarea>
                        </div>
