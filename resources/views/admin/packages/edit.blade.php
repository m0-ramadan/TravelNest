                    ...
                    <div class="wizard-panel" data-step-panel="4">
                        ...
                        <div class="wizard-grid">
                            ...
                            @php
                                ...
                                $savedFacilityTitles = isset($package) && $package->facilities
                                    ? $package->facilities->pluck('title')->map(fn ($t) => trim((string) $t))->all()
                                    : [];

                                $rawOldFacilities = old('facilities');
                                $oldFacilityTitles = $rawOldFacilities !== null
                                    ? collect($rawOldFacilities)->pluck('title')->filter()->map(fn ($t) => trim((string) $t))->all()
                                    : $savedFacilityTitles;
