    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">تعديل وسيلة الدفع</li>
            </ol>
        </nav>
        ...
        <div class="main-card">
            <div class="main-header d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">تعديل وسيلة الدفع</h5>
                    <small class="opacity-75">{{ $paymentMethod->name ?? '' }}</small>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="currency_code" class="form-control"
                                value="{{ old('currency_code', $paymentMethod->currency_code) }}">
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="config" class="form-control" rows="5">{{ old('config', is_array($paymentMethod->config ?? null) ? json_encode($paymentMethod->config, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : $paymentMethod->config ?? '') }}</textarea>
                        </div>
