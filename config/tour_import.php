...
return [
    ...
    */
    'allowed_hosts' => array_values(array_filter(array_map('trim', explode(
        ',',
        env('TOUR_IMPORT_ALLOWED_HOSTS', 'luxorandaswan.com,www.luxorandaswan.com,ramassidetours.com,www.ramassidetours.com,egypttoursportal.com,www.egypttoursportal.com')
    )))),
